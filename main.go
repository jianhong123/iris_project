...
import (
	...
	"main/CmsProject/controller"
	"main/CmsProject/datasource"
	"main/CmsProject/service"
	"main/CmsProject/config"
	"time"
)
...
func mvcHandle(app *iris.Application){
	...
	static:=mvc.New(app.Party("/static/{model}{date}/"))
	static.Register(
		statisService,
		sessManager.Start,
		)
	static.Handle(new(controller.StatisController))
